...
export const MOCK_PRODUCTS = [
  {
    ...
    description:
      "Coordinated mug and hoodie with matching artwork. Perfect gift set for coffee lovers. The ceramic mug features the same design as the hoodie for a cohesive look.",
    price: 54.99,
    originalPrice: 60,
    discount: 5.01,
  ...
  },
  {
    ...
    description:
      "Premium quality black hoodie made from soft cotton blend. Perfect for everyday wear with a comfortable fit and durable construction.",
    price: 34.99,
    originalPrice: null,
    discount: null,
    category: "hoodies",
