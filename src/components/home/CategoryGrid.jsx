...
export default function CategoryGrid() {
  ...
  const CATEGORIES = [
    {
      id: 1,
      title: t('categories.thirtyOffHoodies'),
      description: t('categories.limitedTimeOffer'),
    ...
    {
      id: 2,
      title: t('categories.coupleMatchingSets'),
      description: t('categories.perfectForPartners'),
    ...
    {
      id: 3,
      title: t('categories.designYourOwn'),
      description: t('categories.unleashCreativity'),
