      ...
      items: [
        {
          ...
          image: 'https://readdy.ai/api/search-image?query=Premium%20black%20hoodie&width=200&height=200',
          quantity: 2,
          price: 45.99,
        },
        {
          ...
          image: 'https://readdy.ai/api/search-image?query=Couple%20hoodies&width=200&height=200',
          quantity: 1,
          price: 79.99,
        },
      ],
      ...
      items: [
        {
          ...
          image: 'https://readdy.ai/api/search-image?query=Premium%20t-shirt&width=200&height=200',
          quantity: 1,
          price: 89.99,
        },
      ],
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 pb-4 border-b border-gray-200">
              ...
              <div className="flex items-center gap-3">
                <span className={cn('px-3 py-1 rounded-full text-xs font-semibold', statusInfo.color)}>
                  {statusInfo.label}
                </span>
