      ...
      <div className="bg-white rounded-2xl overflow-hidden shadow-lg flex-1 order-1 lg:order-2">
        <div className="aspect-square  relative group lg:aspect-4/4">
          ...
          <button
            ...
            className="absolute top-3 right-3 w-10 h-10 lg:w-12 lg:h-12 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white transition-colors cursor-pointer"
